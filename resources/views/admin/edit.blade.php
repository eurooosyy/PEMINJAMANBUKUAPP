...
@section('content')
    ...
    <div class="form-container">
        ...
        <div class="page-header">
            ...
            <p>Update informasi buku: {{ $equipment->title }}</p>
        </div>

        <!-- Info Box -->
        <div class="info-box">
            <i class="fas fa-info-circle"></i>
            <strong>Tips:</strong> Perbarui informasi buku dan simpan perubahan untuk mengupdate data di sistem.
        </div>
        ...
        <!-- Form Card -->
        <div class="form-card">
            <form action="{{ route('books.update', $equipment->id) }}" method="POST" enctype="multipart/form-data"
                id="bookForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-row">
                        <div>
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                placeholder="Masukkan judul buku" value="{{ old('title', $equipment->title) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" id="author" name="author"
                                placeholder="Nama penulis" value="{{ old('author', $equipment->author) }}" required>
                    ...
                    <div class="form-row">
                            ...
                            <select class="form-control" id="category" name="category" required>
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category }}"
                                        {{ old('category', $equipment->category) == $category ? 'selected' : '' }}>
                                        {{ $category }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" id="isbn" name="isbn"
                                placeholder="978-3-16-148410-0" value="{{ old('isbn', $equipment->isbn) }}" maxlength="20">
                    ...
                    <div class="form-row">
                        <div>
                            ...
                            <input type="text" class="form-control" id="publisher" name="publisher"
                                placeholder="Gramedia / Erlangga" value="{{ old('publisher', $equipment->publisher) }}">
                            <span class="form-text text-muted">Penerbit buku</span>
                        </div>
                        <div>
                            <label for="year" class="form-label">Tahun Terbit</label>
                            <input type="number" class="form-control" id="year" name="year"
                                value="{{ old('year', $equipment->year) }}" min="1900" max="{{ date('Y') + 1 }}">
                    ...
                    <div class="form-row">
                        <div>
                            ...
                            <input type="number" class="form-control" id="stock" name="stock"
                                placeholder="Jumlah eksemplar" value="{{ old('stock', $equipment->stock) }}" min="0"
                                required>
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" id="shelf" name="shelf"
                                placeholder="Rak A1 / Rak Fiksi 3" value="{{ old('shelf', $equipment->shelf) }}">
                ...
                <div class="form-section">
                    ...
                    @if ($equipment->image)
                        <div class="current-image-section">
                            <h4><i class="fas fa-check-circle" style="color: #48bb78;"></i> Sampul Saat Ini</h4>
                            <img src="{{ asset('storage/' . $equipment->image) }}" alt="{{ $equipment->title }}">
                        </div>
                    @endif

                    <div>
                        <label for="image" class="form-label">Upload Sampul Baru (Opsional)</label>
                        <div style="display: flex; gap: 30px; align-items: flex-start;">
                            ...
                            <div>
                                ...
                                <small class="form-text text-muted" style="display: block; margin-top: 10px;">
                                    Format: JPG, PNG, GIF <br> Maksimal: 2MB
                                </small>
                            </div>
                            ...
                            <div style="flex: 1;">
                                ...
                                <button type="button" class="btn btn-secondary"
                                    ...
                                    <i class="fas fa-cloud-upload-alt"></i> Pilih File Baru
                                </button>
                                <p class="form-text text-muted" style="margin-top: 10px;">
                                    Jika Anda ingin mengganti sampul, pilih file baru. Jika ingin mempertahankan sampul
                                    lama, biarkan kosong.
                                </p>
                            </div>
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4"
                            placeholder="Sinopsis singkat atau informasi tambahan tentang buku">{{ old('description', $equipment->description) }}</textarea>
